...
export default function Homeuna() {
  return (
    <main
      style={{ padding: "40px", backgroundColor: "var(--color-background)" }}
    >
      {/* Título */}
      <header style={{ textAlign: "center", marginBottom: "40px" }}>
        <h1 style={{ color: "var(--color-primary)", fontSize: "2em" }}>
          ¿Son las condiciones ambientales de Chía aptas para el desarrollo de
          cultivos?
        </h1>
      </header>
        ...
        <div style={{ display: "flex", justifyContent: "center", gap: "40px" }}>
          <div style={{ width: "200px", textAlign: "center" }}>
            ...
            <p style={{ color: "var(--color-text-light)" }}>
              Administra toda la información de cultivos y condiciones
              ambientales en un solo lugar.
            </p>
          </div>
          <div style={{ width: "200px", textAlign: "center" }}>
            <Image
              src="/images/cultivos.png"
              alt="Programación fácil"
              width={100}
              height={100}
            />
            <h3 style={{ color: "var(--color-primary)" }}>
            ...
            <p style={{ color: "var(--color-text-light)" }}>
              Identifica las mejores épocas y condiciones para maximizar la
              producción.
            </p>
          </div>
          <div style={{ width: "200px", textAlign: "center" }}>
            ...
            <p style={{ color: "var(--color-text-light)" }}>
              Mejora el rendimiento y la sostenibilidad con análisis de datos en
              tiempo real.
            </p>
          </div>
        </div>
